...
namespace Backend.Migrations
{
    ...
    [Migration("20240814211746_KlientiCrud")]
    partial class KlientiCrud
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lab1_Backend.Models.Klienti", b =>
                {
                    ...
                    b.Property<int>("KlientiGjiniaID")
                        .HasColumnType("int");

                    b.Property<int>("KlientiQytetiID")
                        .HasColumnType("int");

                    b.Property<int>("KlientiRoliID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("KlientiGjiniaID");

                    b.HasIndex("KlientiQytetiID");

                    b.HasIndex("KlientiRoliID");
            ...
            modelBuilder.Entity("Lab1_Backend.Models.KlientiGjinia", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("KlientiGjiniaID"));

                    b.Property<string>("Gjinia")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("KlientiGjiniaID");
            ...
            modelBuilder.Entity("Lab1_Backend.Models.KlientiQyteti", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("KlientiQytetiID"));

                    b.Property<string>("Qyteti")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("KlientiQytetiID");
            ...
            modelBuilder.Entity("Lab1_Backend.Models.KlientiRoli", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("KlientiRoliID"));

                    b.Property<string>("Roli")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("KlientiRoliID");
            ...
            modelBuilder.Entity("Lab1_Backend.Models.Klienti", b =>
                {
                    b.HasOne("Lab1_Backend.Models.KlientiGjinia", "KlientiGjinia")
                        .WithMany()
                        .HasForeignKey("KlientiGjiniaID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Lab1_Backend.Models.KlientiQyteti", "KlientiQyteti")
                        .WithMany()
                        .HasForeignKey("KlientiQytetiID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Lab1_Backend.Models.KlientiRoli", "KlientiRoli")
                        .WithMany()
                        .HasForeignKey("KlientiRoliID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("KlientiGjinia");

                    b.Navigation("KlientiQyteti");

                    b.Navigation("KlientiRoli");
                });
