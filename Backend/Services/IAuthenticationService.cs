...
namespace Lab1_Backend.Services
{
    ...
    {
        Task<(string Token, string RefreshToken, string Roli, int ID, string Emri, string Mbiemri, string KlientiGjinia, string KlientiQyteti, string Email, DateTime expiration)> AuthenticateAndGetJwtToken(LoginModel loginModel);
